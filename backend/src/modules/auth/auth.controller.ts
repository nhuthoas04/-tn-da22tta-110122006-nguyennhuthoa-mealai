import {
    Controller, Post, Get, Put, Delete, Body, UseGuards, Request, Param,
} from '@nestjs/common';
...
export class AuthController {
    ...
    @Roles('admin')
    @Put('admin/users/:id')
    adminUpdateUser(@Param('id') id: string, @Body() dto: { fullName?: string; email?: string; password?: string; role?: string }) {
