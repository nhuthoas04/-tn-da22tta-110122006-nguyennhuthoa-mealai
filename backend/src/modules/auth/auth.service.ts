...
export class AuthService {
        ...
        return {
            ...
            preferences: user.preferences
                ? {
                    ...
                    maxSugarPerMeal: user.preferences.maxSugarPerMeal ? Number(user.preferences.maxSugarPerMeal) : null,
                    maxSodiumPerMeal: user.preferences.maxSodiumPerMeal ? Number(user.preferences.maxSodiumPerMeal) : null,
                    minProteinPerMeal: user.preferences.minProteinPerMeal ? Number(user.preferences.minProteinPerMeal) : null,
                }
                : null,
        };
    }
    ...
    async updateProfile(userId: string, dto: UpdateProfileDto) {
        ...
        const breakdown = this.calorieService.getMealDistribution(user.dailyCalorieTarget);
    ...
    async adminUpdateUser(id: string, dto: { fullName?: string; email?: string; password?: string; role?: string }) {
