import {
    ...
    Param, Body, UseGuards, Request, Res, NotFoundException,
} from '@nestjs/common';
...
export class ShoppingListController {
    ...
    generate(
        ...
        return this.shoppingListService.generateFromPlan(req.user.id, dto.mealPlanId, dto.days);
    }

    @Post('add-recipe')
    addRecipe(
        @Request() req,
        @Body() dto: { recipeId: string },
    ) {
    ...
    markPurchased(
        ...
        return this.shoppingListService.markPurchased(req.user.id, id, itemId, isPurchased);
    }
