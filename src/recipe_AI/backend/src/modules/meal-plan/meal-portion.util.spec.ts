...
describe('calculateMealPortionWarning', () => {
  ...
  it('warns for 2 people when the menu has more than 6 dishes per day', () => {
    const result = calculateMealPortionWarning({
      servings: 2,
      totalDishes: 7,
      dailyCalories: 2200,
    ...
    expect(result.totalPortions).toBe(14);
  });

  it('warns for 4 people when the menu has more than 6 dishes per day', () => {
    const result = calculateMealPortionWarning({
      servings: 4,
      totalDishes: 7,
      dailyCalories: 2100,
    ...
    expect(result.totalPortions).toBe(28);
  });
  ...
  it('warns for 6 people when the menu has more than 6 dishes per day', () => {
    const result = calculateMealPortionWarning({
      servings: 6,
      totalDishes: 7,
      dailyCalories: 2300,
    ...
    expect(result.totalPortions).toBe(42);
  });
});
